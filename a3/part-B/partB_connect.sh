...
$ofctl add-flow r1 \
    ip,nw_src=10.1.1.7nw_dst=10.4.4.48,actions=mod_dl_src:0A:00:01:01:00:02,mod_dl_dst:0A:00:04:01:00:02,output=2

$ofctl add-flow r2 \
    ip,nw_src=10.1.1.7nw_dst=10.4.4.48,actions=mod_dl_src:0A:00:03:01:00:01,mod_dl_dst:00:00:00:00:00:02,output=1
