...
$ofctl add-flow r1 \
    ip,nw_src=,10.1.1.7nw_dst=10.4.4.48,output=2

$ofctl add-flow r2 \
    ip,nw_src=,10.1.1.7nw_dst=10.4.4.48,output=1

# OVS rules for switch bob->alice
$ofctl add-flow r2 \
    ip,nw_src=,10.4.4.48,nw_dst=10.1.1.7,output=2

$ofctl add-flow r1 \
    ip,nw_src=,10.4.4.48,nw_dst=10.1.1.7,output=1
